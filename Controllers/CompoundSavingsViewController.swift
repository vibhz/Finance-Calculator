...
class CompoundSavingsViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func onSave(_ sender: UIBarButtonItem) {
        ...
        if presentValueField.checkIfEmpty() == false && futureValueField.checkIfEmpty() == false && interestField.checkIfEmpty() == false && numberOfYearsField.checkIfEmpty() == false {
            ...
            if(compoundSavings.presentValue != 0 && compoundSavings.futureValue != 0 && compoundSavings.interestAmount != 0 && compoundSavings.numberOfYears != 0) {
                ...
                (compoundSavings.presentValue, compoundSavings.futureValue, compoundSavings.interestAmount, compoundSavings.numberOfYears) = (0,0,0,0)
    ...
    @IBAction func onCalculate(_ sender: UIButton) {
        ...
        if presentValueField.checkIfEmpty() == true && futureValueField.checkIfEmpty() == false && interestField.checkIfEmpty() == false && numberOfYearsField.checkIfEmpty() == false {
            ...
            compoundSavings.interestAmount = Double(interestField.text!)!
            compoundSavings.numberOfYears = Double(numberOfYearsField.text!)!
            
            presentValueField.text = String(compoundSavings.presentValueCalculation())
            ...
            futureValueField.text = String(compoundSavings.futureValueCalculation())
            storeTextFieldValues()
            ...
            interestField.text = String(compoundSavings.compoundIRCalculation())
            storeTextFieldValues()
            ...
            numberOfYearsField.text = String(compoundSavings.numberOfYearsCalculation())
            storeTextFieldValues()
